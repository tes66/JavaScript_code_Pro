const button = document.querySelector('.registrator-button');
const modal = document.querySelector('.modal');
const opentrash = document.querySelector('.opentrash');

  registrator-button.addEventListener('click', function (e) {
    e.stopPropagation();
  ...
  var formValidation = function(e) {
      ...
      if (result == false) {
          document.getElementById('form-box__area__headline').innerText = "Исправте выделенные поля"
      }
      if (result == true) {
          document.getElementById('form-box__area__headline').innerText = "Спасибо! Вы зарегистрированы."
      }
